        ...
        return {
            ...
            controller: ['$scope', function($scope) {
                ...
                var progressChange = function(progress, duration) {
                    console.log('Previous progress'+$scope.track.progress);
                    console.log('Passed progress'+progress);
                    $scope.track.progress = progress;
                    console.log('Changed progress'+$scope.track.progress);
    ...
    .directive('ionAudioProgressBar', ['MediaManager', function(MediaManager) {
        return {
            ...
            template:
                ...
                '<div class="progress-wrapper"><div class="progress ng-binding" style="top: 50%; bottom: auto; left: 50%; transform: translateY(-50%) translateX(-50%); font-size: 35.7143px;"><img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Scorpions-29.jpg" width="190" height="190" style="border-radius: 200px;"> </div> <div  style="text-align:center" round-progress max="track.duration" current="track.progress" color="#FC8053" bgcolor="#eaeaea" radius="100" stroke="8" semi="false" rounded="true" clockwise="true" responsive="false" duration="800" animation="easeInOutQuart"><defs><marker id="circle" markerUnits="strokeWidth" orient="auto" viewBox="0 0 25 25" refX="12.5" refY="12.5" overflow="visible"><path d="M 12.4999 0 A 12.5 12.5 0 1 0 12.5 0" fill="#FC8053" stroke="#eaeaea" stroke-width="3"/> </marker> </defs>  </div> </div>',
