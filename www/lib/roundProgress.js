    ...
    .directive('roundProgress', ['$window', 'roundProgressService', 'roundProgressConfig', function($window, service, roundProgressConfig){
            ...
            return angular.extend(base, {
                ...
                template:[
                    ...
                    //'    <defs> <marker id = "StartMarker" viewBox = "0 0 12 12" refX = "12" refY = "6" markerWidth = "3" markerHeight = "3" stroke = "green" stroke-width = "2" fill = "none" orient = "auto"> <circle cx = "6" cy = "6" r = "5"/> </marker></defs>',
                            '<circle fill="none"/>',
                            '<path fill="none" marker-end = "url(#StartMarker)" />',
                            '<g ng-transclude></g>',
                        '</svg>',
                    '</div>'
                ].join('\n')
